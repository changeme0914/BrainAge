...
class Brain_network(graph_dataset):
    ...
    def process(self):
        node_path = os.path.join(self.raw_dir, 'MRI/node_feature')
        adjacency_path = os.path.join(self.raw_dir, 'MRI/adjacency_matrix')
        age_path = os.path.join(self.raw_dir, 'MRI/age')
